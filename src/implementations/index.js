...
const node20 = new BTreeNode(true, [71, 72], null, tree);
...
const node9 = new BTreeNode(false, [75], [node20], tree);
const node8 = new BTreeNode(false, [65], [node18, node19], tree);
...
const node3 = new BTreeNode(false, [63, 70], [node7, node8, node9], tree);
